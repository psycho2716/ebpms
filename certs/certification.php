            ...
            <div class="document-body">
                ...
                <div class="clearance-body">
                    ...
                    <div class="body-text">
                        ...
                        <p class="body-letter">
                            THIS IS TO CERTIFY that the Office of <?php echo $address; ?> has no file on
                            records/copy of the following documents pertaining to the KALAHI-CIDDS
                        ...
                        <ul>
                            <li class="mb-2">
                                <span class="fw-bold">1'st to 5'th Barangay Assembly Minutes Forms (CDD-05), Household
                                    Participation (CDD-04) and Attendance Sheets (CDD-07) for NCCDP-1.
                                </span>
                            </li>
                            <li class="mb-2">
                                <span class="fw-bold">
                                    Barangay Accountability Reporting Minutes Forms (CDD-05) and Attendance Sheets
                                    (CDD-07) for NCCDP-1.
                                </span>
                            </li>
                            <li class="mb-2">
                                <span class="fw-bold">
                                    Community Monitoring planning Minutes, Minutes Forms (CDD—05) and
                                    Attendance Sheets (CDD-07) for NCDDP-1.
                                </span>
                            </li>
                        </ul>
                        </p>
                        ...
                        <p class="body-letter fw-bold">
                            The above documents are totally damaged by insect infestation.
                        </p>
                        <p class="body-letter fw-bold">
                            Issued this
