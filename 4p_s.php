                    ...
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <div class='modal-body'>
                                <form action='4p_s.php?edit_id=$resident_id' method='post'>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="cert-modal-body modal-body">
                        <ol>
                            <li>
                                <a href="certs/barangay_clearance.php?resident_id=<?php echo $resident_id; ?>&&purok_id=<?php echo $purok_id; ?>&&4p_s">Barangay Clearance</a>
                            </li>
                            <li>
                                <a href="certs/business_clearance.php?resident_id=<?php echo $resident_id; ?>&&purok_id=<?php echo $purok_id; ?>&&4p_s">Business Clearance</a>
                            </li>
                            <li>
                                <a href="certs/certification.php?resident_id=<?php echo $resident_id; ?>&&purok_id=<?php echo $purok_id; ?>&&4p_s">Barangay Certification</a>
                            </li>
                            <li>
                                <a href="certs/certificate_of_travel.php?resident_id=<?php echo $resident_id; ?>&&purok_id=<?php echo $purok_id; ?>&&4p_s">Certificate of Travel</a>
                            </li>
                            <li>
